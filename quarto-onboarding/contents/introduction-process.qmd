...
| **SharePoint** | Documents & personal time registration | [Students documents](https://dtudk.sharepoint.com/:f:/r/sites/PythonInstallationSupport/Delte%20dokumenter/Students%20documents?csf=1&web=1&e=LVnQbU){target="_blank"} |
| **DTU FUSION** | Official time registration | [DTU Fusion](https://www.fusion.dtu.dk){target="_blank"} |
